 ...
 * sibling CLI whose format FastVibe's own engine speaks first, then the three that
 ...
 */
export const IMPORT_ADAPTERS: ImportAdapter[] = [piAdapter, claudeCodeAdapter, codexAdapter, opencodeAdapter];
