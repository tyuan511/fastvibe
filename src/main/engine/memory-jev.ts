...
import {
  ...
  isTemporalQuestion,
  type Route,
} from "./memory-jev-text.ts";

export { baselineNeeds, describeReferences, detectQueryIntent, extractEntities, extractKeywords, isTemporalQuestion };
export type { Route, TemporalReference } from "./memory-jev-text.ts";
