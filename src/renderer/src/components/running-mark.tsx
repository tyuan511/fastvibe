 ...
 */
export function RunningMark({ className, label = "运行中" }: { className?: string; label?: string }): JSX.Element {
  return (
    <span className="flex size-3.5 shrink-0 items-center justify-center" role="status" aria-label={label}>
      <svg
        viewBox="0 0 16 16"
